define(['avalon','text!./avalon.rate.html', 'css!./avalon.rate.css'], function(avalon , template) {
	var _interface = function () {};
	avalon.component("aoyou:rate", {
		//外部标签属性
		label: '',
		name: 'rate',
		num: 5,       //星星默认个数
	...
	var widget = avalon.components["aoyou:rate"];
  return avalon
});
